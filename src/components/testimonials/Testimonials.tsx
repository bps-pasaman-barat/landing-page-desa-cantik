      ...
      <section className="py-24 bg-slate-50 relative overflow-hidden">
        ...
        <div className="container mx-auto px-6 relative z-10">
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-sm font-bold text-orange-600 tracking-wider uppercase mb-2">Dampak Program</h2>
                ...
                <Card className="h-full border-0 shadow-xl shadow-slate-200/50 hover:-translate-y-2 transition-transform duration-300">
                  <CardContent className="p-8 relative">
                    ...
                    <div className="flex items-center gap-4 mb-6">
                      <div className="w-14 h-14 rounded-full bg-gradient-to-br from-orange-400 to-slate-900 flex items-center justify-center text-white font-bold text-xl">
